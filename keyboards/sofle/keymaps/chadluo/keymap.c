...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
     * | LCtr | (G)A | (A)S | (C)D | (S)F |   G  |-------.    ,-------|   H  | (S)J | (C)K | (A)L | (G); |  '   |
     * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
    ...
    [_COLEMAK] = LAYOUT(KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, /* */ KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV,                             //
...
static void print_version(void) {
    oled_write_ln_P(PSTR("2023-09-09"), false);
    oled_write_ln_P(PSTR("TEST: slave display"), false);
}
